-- Langar Bar V4.5.0 — Order RPC, customer tracking, admin realtime/polling fix
-- Run this once in Supabase SQL Editor after uploading V4.5.0.
...
begin
  ...
  insert into public.customer_orders (
    ...
    false,
    now(),
    jsonb_build_array(jsonb_build_object('status','new','at',now(),'by','customer_app','version','v450'))
  )
