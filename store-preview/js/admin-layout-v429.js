// Langar Admin V4.2.9 — stable clean dashboard + pull refresh fix
(function(){
  'use strict';
  ...
  function injectStyles(){
    if($('#adminLayout429Styles')) return;
    const st=document.createElement('style'); st.id='adminLayout429Styles';
    st.textContent = `
  ...
  async function renderDashboard(){
    ...
    p.innerHTML=`
      <div class="admin-clean-dashboard">
        <div class="admin-hub-header"><h2>Admin Dashboard</h2><p class="muted">همه بخش‌های ادمین مثل منوی اصلی اپ دسته‌بندی شده‌اند. روی هر کارت بزن تا همان بخش باز شود.</p></div>
