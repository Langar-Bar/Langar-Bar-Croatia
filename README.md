Langar Bar App V4.2.2 — Cloud Sushi + Mobile Admin
...
- Service Worker cache updated to V4.2.2.

Test URLs:
App:   https://langar-bar.github.io/Langar-Bar-Croatia/?v=422
Admin: https://langar-bar.github.io/Langar-Bar-Croatia/admin.html?v=422
